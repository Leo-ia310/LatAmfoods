const translations = {
  es: {
    ...
    "cov-eyebrow": "COBERTURA EN EE.UU.",
    "cov-title": "Llegamos a donde <em>están tus clientes</em>",
    "cov-desc": "Distribucion activa en Colorado, California, Arizona, Wyoming, Florida, Utah, New Mexico, Kansas y Nebraska.",
  ...
  en: {
    ...
    "cov-eyebrow": "U.S. COVERAGE",
    "cov-title": "We reach where <em>your customers are</em>",
    "cov-desc": "Active distribution in Colorado, California, Arizona, Wyoming, Florida, Utah, New Mexico, Kansas, and Nebraska.",
